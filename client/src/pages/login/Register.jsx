	...
	<div className="h-screen p-14">
		<div className="minmd:px-4 minlg:px-8 minlg:mb-[-98px] mt-[100px] password-reset password-reset">
			<div className="email-form">
				<h1 className="text-lg text-primary-400">CREATE NEW ACCOUNT</h1>
				...
				<div className="loginForm">
							...
							<div className="password">
								...
								<input
									...
									className="mt-1 block w-full px-3 py-2 bg-white border-primary-100 rounded-md text-sm shadow-sm placeholder-slate-400
							...
							<div>
								<button className="text-neutral-100 bg-gradient-to-r from-primary-400 to-primary-800 text-lg w-full sm:w-auto px-6 py-3 text-center rounded-full" onClick={register}>
									Create Account
								</button>
							</div>
